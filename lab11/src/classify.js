...
photo.addEventListener('change', (event) => {
  ...
  // Get the Image from the loaded image object
  // imageData = ctx.getImageData(0,0,image.width, image.height);

  // let b64Image = b64EncodeUnicode(imageData.toString());
...
classify.addEventListener('click', (event) => {
  ...
  console.log("Encode the image as base64");
  console.log("Create the AutoML Proxy Object ");
  console.log("Perform fetch against AutoML Proxy");
